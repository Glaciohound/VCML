...
class TrainOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--not_bidirectional', action='store_true',
                                 help='forbid bidirectional encoder')
        ...
        self.parser.add_argument('--vcml_question_path',
                                 default='../data/vcml_data/CLEVR/augmentation/questions/normal_exist_both')
        self.parser.add_argument('--vcml_question_size',
                                 default=600000)
        self.parser.add_argument('--epochs', default=100)
        self.parser.add_argument('--null_image', default='NULLIMAGE')
        self.parser.add_argument('--random_seed', default=0)
        self.parser.add_argument('--ipython', action='store_true')
        self.parser.add_argument('--val_size', type=str, default=100)
