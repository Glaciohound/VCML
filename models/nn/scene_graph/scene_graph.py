...
class SceneGraph(nn.Module):
    def __init__(self, feature_dim, output_dims, downsample_rate, relation=True):
        super().__init__()
        self.pool_size = 7
        ...
        for i in range(input.size(0)):
            ...
            if DEBUG:
                ...
                if self.relation:
                    ...
                    outputs.append([None, self._norm(self.object_feature_fc(this_object_features.view(box.size(0), -1))), None])
